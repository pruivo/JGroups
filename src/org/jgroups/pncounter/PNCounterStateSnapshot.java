 ...
 * @since 12.0
 */
public class PNCounterStateSnapshot implements SizeStreamable {

    private long pCounter;
    private long nCounter;

    public PNCounterStateSnapshot() {
    }

    public PNCounterStateSnapshot(long pCounter, long nCounter) {
    ...
    public boolean equals(Object o) {
        ...
        PNCounterStateSnapshot that = (PNCounterStateSnapshot) o;
